...
def mine_block():
    ...
    blockchain.add_transaction(sender=node_address, receiver='Martin', amount=1)
...
def connect_node():
    ...
    response = {'message': 'All nodes are now connected. The Martincoin contains the following nodes:',
