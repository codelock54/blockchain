...
class BlockchainMG:
    ...
    def replace_chain(self):
        ...
        if longest_chain and max_length > len(self.chain):
...
def mine_block():
    ...
    blockchain.add_transaction(sender=node_address, receiver='Juan', amount=1)
...
def connect_node():
    ...
    response = {'message': 'All nodes are now connected. The blockchain contains the following nodes:',
...
def replace_chain():
    ...
    if is_chain_replaced:
        ...
        response = {'message': 'Everything is fine. The chain is the longest one.',
